<template lang="pug">
#user-dropdown(class="  w-[calc(30vw+10em)]  px-5 space-y-4 h-screen   top-0   rounded-b-lg rounded-r-lg right-0  z-40 bg-white  shadow-[0px_0px_10px_-2px_rgb(0,0,0,0.15)]  flex-col justify-start items-center ")
