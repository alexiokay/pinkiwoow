...
div.collections-panel(class=" relative flex flex-col sm:flex-row  h-full  w-full gap-x-8 px-8 lg:px-16 mt-12 full-width ")
    div(class="flex flex-col w-full sm:w-1/2 h-full items-center justify-center order-1 sm:order-0  py-8 shadow-lg rounded-xl border-[#EC92BA] border-2") <!-- bg-[#EC92BA] -->
        CollectionsItem(title="Ganja Mug" :bestseller="true" :price="200" :price_pln="200" :rated="8" image="images/products/mugs/ganja-left.webp" image2="images/products/mugs/ganja-right.webp" stripeProductId="200")
        CollectionsItem(title="Ben 10" :price="200" :price_pln="200" :rated="5" image="images/products/mugs/ben-10-left.webp" image2="images/products/mugs/ben-10-right.webp" stripeProductId="200")
...
div.collections-panel(class=" relative flex  sm:hidden  h-full flex-row w-full gap-x-8 px-8 lg:px-16 mt-12 full-width ")
  p dsaads
    </template>
