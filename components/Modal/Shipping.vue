...
div
    ...
    Transition(name="fade")
        <div v-show="isOpen" @click="$emit('close'), addingShipping = false" tabindex="-1" class="fixed top-0 pointer-event-none flex items-center bg-[rgba(0,0,0,0.55)] justify-center left-0 right-0 z-50  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-screen md:h-full"></div>
