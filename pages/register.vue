<template lang="pug">
div#login-page(class="relative flex w-[1440px] h-[57rem] px-12 items-start gap-x-28 justify-center" )
        div(class="flex  flex-col mt-[3.5rem] w-2/6 h-[43rem] items-center justify-center")
        ...
        div(class='w-[29rem] h-auto')
            div(class="text-center w-[25rem] h-auto flex items-start justify-start flex-col mt-6")     
                h2(class="mb-7 text-xl text-gray-800 text-start mt-8 font-itim ") Why is it worth to have an account in pinkiwoow?
                LoginWhy
