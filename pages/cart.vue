...
div(class="flex flex-col w-full h-auto items-center justify-center")
    h1(class="mt-8 mb-8 font-roboto self-start") KOSZYK
    div(class="flex flex-row w-full h-auto mt-4 justify-center  font-roboto  px-8 md:px-12")
    ...
    div(v-for="item in cart" :key='item.title' class="flex flex-row w-full h-auto mt-4 justify-center space-x-2 px-8 md:px-12")
        div(class="flex flex-col w-[30%] md:w-[20%] lg:w-[11%] h-auto")
        ...
        div(class="flex flex-row  justify-center items-start w-aut w-[8.8rem]   h-auto gap-x-2")
        ...
        div(class="flex flex-col w-[15%] justify-start items-end h-auto")
            p(class="w-[3rem] md:w-[4rem] lg:w-[5rem]") {{item.price * item.quantity}} zł
    ...
    div(class="flex flex-col space-y-2 w-full  px-8 md:px-12 ")
    ...
    div#cart-payment-method(class="flex flex-col space-y-2 w-full  px-8 md:px-12")
    ...
    div(class="flex flex-col sm:flex-row justify-start space-x-4 space-y-2 items-center  px-8 md:px-12")
